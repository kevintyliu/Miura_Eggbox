...
leftNote = annotation(gcf,'textbox','String', minStr,'FontName','Tacoma','FontSize',14,'units','normalized',...
    'Position', [xpos-0.05 ypos 0.05 0.03],'Interpreter','Tex','EdgeColor','none',...
    'HorizontalAlignment','center','VerticalAlignment','middle');
rightNote = annotation(gcf,'textbox','String', maxStr,'FontName','Tacoma','FontSize',14,'units','normalized',...
    'Position', [xpos+len ypos 0.05 0.03],'Interpreter','Tex','EdgeColor','none',...
    'HorizontalAlignment','center','VerticalAlignment','middle');
annotation(gcf,'textbox','String', name,'FontName','Tacoma','FontSize',14,'units','normalized',...
